    ...
    <BottomSheetScrollView style={styles.container}>
      ...
      <Text style={styles.description}>
        {activeTab === TAB.PAIR_THIS
          ? t`Scan this QR code or paste the vault key into the Lockwright app on your other device to connect it to your account. This method keeps your account secure.`
          : t`Scan the QR code or paste the vault key from the Lockwright app on your other device to connect it to your account. This method keeps your account secure.`}
      </Text>
